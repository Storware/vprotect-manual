...
Citrix/XCP-ng introduced CBT mechanism in XenServer 7.3. In order to enable CBT backups the following requirements must be met:

1. Citrix/XCP-ng XenServer 7.3 or above must be used - note that CBT is a licensed feature
