...
Note: If you are altering existing vProtect configuration it is very important to preserve /vprotect_data contents and transfer it to new filesystem. Setting up VDO and DRBD will cause all data to be wiped from the configured volume.
...
Afterwards we have defined vdo_resource and fs_resource in one fs_group and updated cluster configuration.
